 ...
 */
export declare type NotificationEventCallback = FuncArg<'warning' | 'error', Error | object> | FuncArg<'auth', FbnsDeviceAuth> | FuncArg<'push' | 'silent_push', FbnsNotificationUnknown> | FuncArg<'exp_logging', {
    beacon_id: number;
