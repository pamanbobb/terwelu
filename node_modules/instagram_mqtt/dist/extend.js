...
function withRealtime(client, initOptions) {
    client = assertClient(client);
    Object.defineProperty(client, 'realtime', { value: new realtime_1.RealtimeClient(client, initOptions), enumerable: false });
    // @ts-ignore
    return client;
}
exports.withRealtime = withRealtime;
function withFbnsAndRealtime(client, initOptions) {
    client = assertClient(client);
    Object.defineProperty(client, 'fbns', { value: new fbns_1.FbnsClient(client), enumerable: false });
    Object.defineProperty(client, 'realtime', { value: new realtime_1.RealtimeClient(client, initOptions), enumerable: false });
    if (client instanceof IgApiClientExt) {
